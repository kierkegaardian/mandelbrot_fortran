...
FALLBACK_GRADE_BANDS: dict[str, str] = {
    "counting": "K-2",
    "add_subtract": "K-5",
    "multiply": "2-6",
    "divide": "3-7",
    ...
    "fractions": "1-8",
    "long_addition": "2-6",
    "long_subtraction": "2-6",
    "long_multiplication": "3-7",
    "long_division": "4-8",
    "money": "K-7",
}
...
def skill_matches_grade(skill: str, grade_band: str | None) -> bool:
    ...
    skill_band = getattr(entry, "grade_band", None) or FALLBACK_GRADE_BANDS.get(skill)
    if not skill_band:
        return True
    return grade_bands_overlap(skill_band, grade_band)
